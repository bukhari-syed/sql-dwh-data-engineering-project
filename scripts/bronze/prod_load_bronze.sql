...
BEGIN
    ...
    DECLARE @beginning_of_script DATETIME, @end_of_script DATETIME;
    BEGIN TRY 
        SET @beginning_of_script = GETDATE();
        PRINT '================================';
        ...
        SET @end_of_script = GETDATE();
        PRINT '>> Total Load Duration: ' + CAST(DATEDIFF(second, @beginning_of_script, @end_of_script) AS NVARCHAR) + ' seconds'
        PRINT '>> --------------------------------------'
    END TRY 
    BEGIN CATCH 
        PRINT '==========================================';
